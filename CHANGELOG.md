...
- New `--input-folder` option that scans all `.txt` within a folder for URLs (non recursive). URLs within the same file will be a group;
  A subfolder within the downloads folder will be created for each group. See: <https://script-ware.gitbook.io/cyberdrop-dl/reference/config/sorting#group-urls>
